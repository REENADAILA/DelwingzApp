...
const TIKKA_PRODUCTS = [
  {
    ...
    oldPrice: '1000',
    discount: '10% OFF',
    image: require('../assets/image/AfganKaPathanChickenTikka.jpeg'), 
    targetScreen: 'AfganKaPathanChickenTikkaDetail', 
    description: 'Fresh aromatic authentic Afghan style chicken tikka.',
  },
  {
    id: 'tk2',
    name: 'Tikka Marinades',
    weight: '165g',
    price: '900',
    oldPrice: '1000',
    discount: '10% OFF',
    image: require('../assets/image/TikkaMarinades.jpeg'), 
...
export default function TikkaMarinadesScreen({ navigation }: any) {
  ...
  const handleAddToCart = async (product: any) => {
    ...
    try {
      ...
      console.log("SQL Insert/Update Exception:", error);
    }
  };
  ...
  const handleRemoveFromCart = async (product: any) => {
    ...
    try {
      ...
      console.log("SQL Decrement/Delete Exception:", error);
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollPadding}>
        ...
        <View style={styles.categoryBanner}>
          ...
          <View style={styles.categoryIconSquare}>
            <Image source={require('../assets/image/TikkaMarinades.jpeg')} style={styles.smallBannerImg} resizeMode="cover" />
          </View>
          <View>
            <Text style={styles.bannerLabel}>CATEGORY</Text>
            <Text style={styles.bannerTitle}>Tikka Marinades</Text>
          </View>
        </View>

        {/* 3. DOUBLE FILTER PILLS ROW */}
        <View style={styles.pillsRow}>
          <View style={styles.activePill}>
            <Text style={styles.activePillText}>All</Text>
          </View>
          <View style={styles.inactivePill}>
            <Text style={styles.inactivePillText}>Ready To Cook</Text>
          </View>
        </View>

        {/* 4. 2-COLUMN PRODUCT GRID */}
        <View style={styles.productsGrid}>
          {TIKKA_PRODUCTS.map((product) => {
              ...
              <View key={product.id} style={styles.productCard}>
                ...
                <View style={styles.productBottomActionBlock}>
                  <View style={styles.priceActionRow}>
                    ...
                    {/* CUSTOM SMART INTERACTIVE STATE MODULATOR */}
                    {isAnimating ? (
      ...
      {/* 5. BOTTOM TAB BAR WITH REALTIME LIVE RED BADGE BUBBLE */}
...
const styles = StyleSheet.create({
  ...
  inactivePill: { backgroundColor: '#FFF', paddingVertical: 8, paddingHorizontal: 18, borderRadius: 20, borderWidth: 1, borderColor: '#FFE4E6' },
  inactivePillText: { color: '#2D3748', fontWeight: '700', fontSize: 13 },

...
const RAW_CHICKEN_PRODUCTS = [
  {
    id: 'rc1',
    name: 'Raw Chicken Keema',
    weight: '250g',
    price: '90',
    oldPrice: '100',
    discount: '10% OFF',
    image: require('../assets/image/RawChickenKima.jpeg'), 
    targetScreen: 'RawChickenKeemaDetail',
    description: 'Fresh lean minced raw chicken keema.',
  },
  {
    id: 'rc2',
    ...
    oldPrice: '100',
    discount: '10% OFF',
    image: require('../assets/image/RawChicken.jpeg'),
...
export default function RawChickenScreen({ navigation }: any) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollPadding}>
        ...
        <View style={styles.categoryBanner}>
          ...
          <View style={styles.categoryIconSquare}>
            <Image source={require('../assets/image/RawChicken.jpeg')} style={styles.smallBannerImg} resizeMode="cover" />
          </View>
          <View>
            <Text style={styles.bannerLabel}>CATEGORY</Text>
            <Text style={styles.bannerTitle}>Raw Chicken</Text>
          </View>
        </View>
        ...
        <View style={styles.pillsRow}>
          ...
          <View style={styles.inactivePill}>
            <Text style={styles.inactivePillText}>Raw Chicken</Text>
          </View>
        </View>

        {/* 4. 2-COLUMN PRODUCT GRID */}
        <View style={styles.productsGrid}>
          {RAW_CHICKEN_PRODUCTS.map((product) => {
            ...
            return (
              <View key={product.id} style={styles.productCard}>
                ...
                {/* Lower Interactive Action Block */}
      ...
      {/* 5. BOTTOM TAB BAR WITH REALTIME NOTIFICATION BADGE COUNTER */}
